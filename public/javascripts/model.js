function Model (settings) {
  // Set to debug mode
  this.isDebug = false;
  // Set the URLs according to the 'settings' object

  // Data storage
  this.progListData = null;
  this.selectedSeries = null;
  this.neighborData = null;
  
  this.currentQueryDateStr = '';
  this.currentQueryPid = null;
  this.pidToStartdate = {};
}
Model.prototype.SetController = function(ctrl) {
  this.controller = ctrl;
};

Model.prototype.MFetchDataBy = function(strPid) {
  if (this.isDebug) {
    // Series data
    this.selectedSeries = {};
    this.selectedSeries['real'] = [65.0, 849.0, 983.0, 910.0, 874.0, 581.0, 460.0, 376.0, 338.0, 236.0, 220.0, 200.0, 206.0, 199.0, 184.0, 163.0, 156.0, 152.0, 125.0, 127.0, 164.0, 113.0, 78.0, 85.0, 66.0, 62.0, 74.0, 75.0, 91.0, 96.0, 90.0, 57.0, 68.0, 54.0, 64.0, 48.0, 45.0];
    this.selectedSeries['pred'] = [434.0, 352.0, 325.0, 324.0, 280.0, 244.0, 214.0, 196.0, 163.0, 168.0, 154.0, 134.0, 113.0, 114.0, 99.0, 87.0, 89.0, 95.0, 89.0, 77.0, 76.0, 78.0, 69.0, 74.0, 76.0, 66.0, 58.0, 60.0, 68.0, 66.0];
    this.selectedSeries['realStartDate'] = '2013-04-19';
    this.selectedSeries['predStartDate'] = '2013-04-26';
    // Neighbor data
    this.neighborData = [
    ...
    setTimeout('controller.CMFetchDataFinished.bind(controller)();',500);
    return;
  }

  var pid = parseInt(strPid);
  this.currentQueryPid = pid;

  successCallback = (function (data, textStatus, jqXHR) {
    this.selectedSeries = data.selectedSeries;
    this.selectedSeries['realStartDate'] = this.pidToStartdate[this.currentQueryPid];
    this.neighborData = data.neighborData;
    this.controller.CMFetchDataFinished.bind(this.controller)();
  }).bind(this);
...
Model.prototype.MFetchProgListBy = function (strDate) {
  if (this.isDebug) {
    this.progListData = [{ "progid" : 565035, "progname" : "识法代言人[粤][6]", "genre" : "情感剧;家庭剧;职业剧;" },{ "progid" : 566027, "progname" : "故梦[21]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 557404, "progname" : "烈火雄心II[35]", "genre" : "情感剧;励志剧;职业剧;" },{ "progid" : 560553, "progname" : "故梦[7]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 560555, "progname" : "故梦[8]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 560560, "progname" : "故梦[9]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 553250, "progname" : "风雨雕花楼[18]", "genre" : "情感剧;" },{ "progid" : 553254, "progname" : "风雨雕花楼[19]", "genre" : "情感剧;" },{ "progid" : 553259, "progname" : "风雨雕花楼[20]", "genre" : "情感剧;" },{ "progid" : 547411, "progname" : "望族[33]", "genre" : "家族剧;商战剧;" }];

    setTimeout('controller.CMFetchProgListFinished.bind(controller)( [{ "progid" : 565035, "progname" : "识法代言人[粤][6]", "genre" : "情感剧;家庭剧;职业剧;" },{ "progid" : 566027, "progname" : "故梦[21]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 557404, "progname" : "烈火雄心II[35]", "genre" : "情感剧;励志剧;职业剧;" },{ "progid" : 560553, "progname" : "故梦[7]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 560555, "progname" : "故梦[8]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 560560, "progname" : "故梦[9]", "genre" : "情感剧;家庭剧;民国剧;" },{ "progid" : 553250, "progname" : "风雨雕花楼[18]", "genre" : "情感剧;" },{ "progid" : 553254, "progname" : "风雨雕花楼[19]", "genre" : "情感剧;" },{ "progid" : 553259, "progname" : "风雨雕花楼[20]", "genre" : "情感剧;" },{ "progid" : 547411, "progname" : "望族[33]", "genre" : "家族剧;商战剧;" }]);', 500);
    return;
  }

  this.currentQueryDateStr = strDate;
  var successCallback = (function (data, textStatus, jqXHR) {
    this.progListData = data;
    this.controller.CMFetchProgListFinished.bind(this.controller)(this.progListData);
    this.pidToStartdate = {};
    for (var i=0; i<data.length; i++) {
      this.pidToStartdate[data[i]['progid']] = data[i]['startdate'];
    }
  }).bind(this);
